...
```{r r-interface-2020, echo=TRUE, results="asis"}
...
1. Is there an apparent trend in the number of girls baptized over the years? 
   ...
   *The answer: The number of girls baptized over the years is increasing therefore there is a positive linear 
...
3. Now, generate a plot of the proportion of boys born over time. What do you see? 
   ...
   *The answer: The number of boys baptized increased since 1660 and it became a positive linear
...
1.  How do these counts compare to Arbuthnot's? Are they of a similar magnitude?
    ...
    *The Answer: no they are different than Arbuthnot's, they are in millions and ranges from 1940 - 2002 and the Arbuthnot's in thousands and ranges from 1629 - 1710.
...
1.  Make a plot that displays the proportion of boys born over time. What do you see? 
    ...
    *The Answer: the proportion of boys had increased in the sixties and then decliened in late seventies then increased again in the eighties. and yes Arbuthnot's observation about boys being born in greater proportion than girls hold up in the U.S is true.
...
1.  In what year did we see the most total number of births in the U.S.? *Hint:*
    ...
    *The answer: the year with most births is 1961.
